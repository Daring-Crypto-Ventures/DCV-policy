...
* The same way that Google's [scripts or add-ons terms](https://developers.google.com/apps-script/terms#end_users_using_scripts_or_add-ons) decline to assume any responsibility for scripts or add-ons, we also do decline as declared in such Terms.
